...
var myApp = angular.module('myApp', ['spring-security-csrf-token-interceptor','angular-loading-bar']).config(['cfpLoadingBarProvider', function(cfpLoadingBarProvider) {
    cfpLoadingBarProvider.latencyThreshold = 1;
}]);
 

//Not Necessary to Create Service, Same can be done in COntroller also as method like add() method
myApp.service('filteredListService', function ($http) {
    ...
    this.loadData = function(){
		...
		var res = $http
				.post(
						'/turfclubPrograms/trainersEmployees/service/getHistories');
...
var TableCtrl = myApp.controller('TableCtrl', function ($scope, $filter, filteredListService) {
    ...
    $scope.loadData = function(){
    	$scope.data = filteredListService.loadData();
