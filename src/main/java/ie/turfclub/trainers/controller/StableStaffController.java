...
public class StableStaffController {
	...
	public String listStaffMembers(
		...
		model.addAttribute("trainerName", "Administrator");
		
		model.addAttribute("pdfUploaded", fileService.hasFiles(trainerId));
	...
	public String complete(Model model,@ModelAttribute TeTrainers trainerDetail, 
	...
	public String editStaffMember(Model model,
		...
		if (type.equals("edit") || type.equals("update")) {
			...
			List<TeEmployentHistory> histories = stableStaffService
					.getEmploymentHistories(id, trainerId);
